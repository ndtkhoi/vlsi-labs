...
# Generated on: Wed Nov 19 09:09:04 +07 2025 (Wed Nov 19 02:09:04 UTC 2025)
...
set logfile fv/ex2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ex2 -revised fv_map
...
add_search_path /home/yellow/ee3201_19/Documents/LAB2/ex2/gpdk045_lib -library -both
read_library -liberty -both \
    /home/yellow/ee3201_19/Documents/LAB2/ex2/gpdk045_lib/slow_vdd1v2_basicCells_hvt.lib
...
add_search_path /home/yellow/ee3201_19/Documents/LAB2/ex2/00_src -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/yellow/ee3201_19/Documents/LAB2/ex2/00_src/ex2.sv
elaborate_design -golden -root {ex2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/ex2/fv_map.v.gz
elaborate_design -revised -root {ex2}
...
set_system_mode lec
write_compared_points noneq.compared_points.ex2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ex2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ex2.rtl.fv_map.rpt
