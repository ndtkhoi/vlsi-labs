...
# Generated on: Tue Nov 18 04:59:57 +07 2025 (Mon Nov 17 21:59:57 UTC 2025)
...
set logfile fv/not1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/not1 -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/yellow/ee3201_19/Desktop/LAB2/ex1/00_src/ex1_not.sv
elaborate_design -golden -root {not1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/not1/fv_map.v.gz
elaborate_design -revised -root {not1}
...
set_system_mode lec
write_compared_points noneq.compared_points.not1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.not1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.not1.rtl.fv_map.rpt
