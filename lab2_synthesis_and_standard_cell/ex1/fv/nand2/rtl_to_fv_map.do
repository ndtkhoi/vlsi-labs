...
# Generated on: Tue Nov 18 05:34:42 +07 2025 (Mon Nov 17 22:34:42 UTC 2025)
...
set logfile fv/nand2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/nand2 -revised fv_map
...
add_search_path /home/yellow/ee3201_19/Desktop/LAB2/ex1/gpdk045_lib -library -both
read_library -liberty -both \
    /home/yellow/ee3201_19/Desktop/LAB2/ex1/gpdk045_lib/fast_vdd1v0_basicCells_hvt.lib
...
add_search_path /home/yellow/ee3201_19/Desktop/LAB2/ex1/00_src -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/yellow/ee3201_19/Desktop/LAB2/ex1/00_src/ex1_nand2.sv
elaborate_design -golden -root {nand2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/nand2/fv_map.v.gz
elaborate_design -revised -root {nand2}
...
set_system_mode lec
write_compared_points noneq.compared_points.nand2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.nand2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.nand2.rtl.fv_map.rpt
