...
# Generated on: Tue Nov 18 05:28:16 +07 2025 (Mon Nov 17 22:28:16 UTC 2025)
...
set logfile fv/or2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/or2 -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/yellow/ee3201_19/Desktop/LAB2/ex1/00_src/ex1_or2.sv
elaborate_design -golden -root {or2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/or2/fv_map.v.gz
elaborate_design -revised -root {or2}
...
set_system_mode lec
write_compared_points noneq.compared_points.or2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.or2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.or2.rtl.fv_map.rpt
